...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import('../views/PublicComplaintView.vue'),
    },
    {
      path: '/cs',
      ...
      children: [
        {
          path: '',
          name: 'cs-dashboard',
          component: () => import('../views/cs/DashboardView.vue'),
        },
        {
          path: 'laporan/baru',
          name: 'cs-report-new',
          component: () => import('../views/cs/ReportFormView.vue'),
        },
        {
          path: 'laporan/:id',
          name: 'cs-report-detail',
          component: () => import('../views/cs/ReportFormView.vue'),
        },
        {
          path: 'draft/:localId',
        ...
        { path: 'draft', name: 'cs-drafts', component: () => import('../views/cs/DraftsView.vue') },
        {
          path: 'perbaikan',
          name: 'cs-revisions',
          component: () => import('../views/cs/RevisionsView.vue'),
        },
        {
          path: 'riwayat',
          name: 'cs-history',
